package com.example.mpkAndroid.ui.mapScreen.oAuthLogin
...
const val TAG = "OneTapUserAuth"

@Composable
fun OneTapSignInWithGoogle(
    state: OneTapSignInState,
    clientId: String = "450827284299-rvcq4akjifg5etd921ppvgccfbl2ffoc.apps.googleusercontent.com",
    nonce: String? = null,
    onTokenIdReceived: (UserCredentials) -> Unit,
